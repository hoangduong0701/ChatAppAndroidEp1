                ...
                result -> {
                    if (result.getResultCode() == Activity.RESULT_OK){
                        ...
                        if (data!= null && data.getData()!= null){
                            ...
                            AndroidUtil.setProfilePic(getContext(), selectdImageUri, profilePic);
    ...
    void updateToFireSore(){
        FirebaseUtil.currentUserDetails().set(currentUserModel)
                .addOnCompleteListener(task -> {
                    setInProgress(false);
                    if (task.isSuccessful()){
                        AndroidUtil.showToast(getContext(), "Update thành công");
                    }else {
                        AndroidUtil.showToast(getContext(), "Update thất bại");
                    }
                });
    }
    void getUserData(){
